...
const voltoRoot = fs.existsSync(path.join(workspaceRoot, 'core/packages/volto'))
  ? path.join(workspaceRoot, 'core/packages/volto')
  : path.dirname(
      fileURLToPath(import.meta.resolve('@plone/volto/package.json')),
    );
...
const voltoSlateRoot = resolvePackageRoot(
  '@plone/volto-slate',
  'core/packages/volto-slate',
);
const componentsRoot = resolvePackageRoot(
  '@plone/components',
